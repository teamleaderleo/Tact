...
- [`notes/information-first-product-pages.md`](notes/information-first-product-pages.md) — product pages that put specifications, comparisons, diagrams, engineering explanations, useful photography, ownership facts, and credibility ahead of decorative ceremony.
